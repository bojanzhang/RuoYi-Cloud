...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static boolean matches(String str, String pattern) {
        ...
        do {
            ...
            prefixPattern = substring(pattern, beginOffset, formerStarOffset > -1 ? formerStarOffset :
                    pattern.length());
            ...
            suffixPattern = substring(pattern, formerStarOffset + 1, latterStarOffset > -1 ? latterStarOffset :
                    pattern.length());
